...
public class BubbleSort_2511533003 {
    ...
    public static void bubleSort_3003(int[] arr_3003) {
        ...
        for (int i_3003 = 0; i_3003 < n_3003; i_3003++) {
            for (int j_3003 = 0; j_3003 < n_3003 - i_3003 - 1; j_3003++) {
                if (arr_3003[j_3003] > arr_3003[j_3003 + 1]) {
                    int temp = arr_3003[j_3003];
                    arr_3003[j_3003] = arr_3003[j_3003 + 1];
                    arr_3003[j_3003 + 1] = temp;
                }
            }
        }
    }
